...
# [2] Time Range 조회
test_api "2" "Time Range 조회" "GET" "/api/get_time_range?tagname=$TAGNAME"

# [3] Chunk Info 조회
test_api "3" "Chunk Info 조회" "GET" "/api/get_chunk_info?tagname=$TAGNAME&time=2025-10-21T19:29:01.628667"

# [4] Video Chunk 조회
test_api "4" "Video Chunk 조회" "GET" "/api/v_get_chunk?tagname=$TAGNAME&time=2025-10-21T19:29:01.628667"

# [5] Camera Rollup Info 조회
test_api "5" "Camera Rollup Info 조회" "GET" "/api/get_camera_rollup_info?tagname=$TAGNAME&minutes=1&start_time=1761094496000000000&end_time=1761097487652444000"
...
# [6] 센서 목록 조회
test_api "6" "센서 목록 조회" "GET" "/api/sensors?tagname=$TAGNAME"

# [7] 센서 데이터 조회
test_api "7" "센서 데이터 조회" "GET" "/api/sensor_data?tagname=$TAGNAME&sensors=sensor-1&start=2025-10-21T19:28:07.1234&end=2025-10-21T19:28:09.1234"
...
# [25] 카메라 삭제
test_api "25" "카메라 삭제" "DELETE" "/api/camera/$TEST_CAMERA_ID"
