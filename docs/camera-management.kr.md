...
> 스크린샷 위치: `blackbox-camera-new.png`
>
> 권장 장면: New Camera 화면에서 Table, Camera Name, RTSP URL, Detection 영역이 같이 보이는 화면
...
> 스크린샷 위치: `blackbox-camera-detail.png`
>
> 권장 장면: Camera 상세 화면에서 Enabled 상태, Live Preview 버튼, Edit/Delete 버튼이 같이 보이는 화면
